...
<html class="no-js" lang="en">
    <head>
        ...
        <title>@yield('title') | Demo System - A System for HR Payment Generator.</title>
                ...
                <div class="app-sidebar colored">
                    <div class="sidebar-header">
                        <a class="header-brand" href="{{ url('/') }}">
                            ...
                            <small class="text pl-2"><b>Demo</b>System</small>
                ...
                <footer class="footer">
                    <div class="w-100 clearfix">
                        <span class="text-center text-sm-left d-md-inline-block">
                         {{-- get current year --}}
                            {{ date('Y') }} © <a href="{{ url('https://impactivedigital.ug/') }}" target="_blank">Impactive Digital Uganda</a>. All rights reserved.
                         {{-- get current year --}}
                        </span>
